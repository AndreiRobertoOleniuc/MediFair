...
INSERT INTO summeries (invoiceid, datum, emoji, titel, beschreibung, operation, reasoning, betrag)
VALUES 
  (3, '21.01.2025', '🧑‍⚕️', 'Konsultation', 'Die Konsultation dauerte insgesamt 15 Minuten.', '', 'Die Positionen 00.0010, 00.0020 und 00.0030 beschreiben zusammen eine 15-minütige Konsultation am 21.01.2025. Die Beträge werden zusammengefasst', 42.33),
  (3, '21.01.2025', '👁️', 'Refraktionsbestimmung', 'Subjektive Refraktionsbestimmung durch Facharzt, beidseitig.', '', '', 48.59),
  (3, '21.01.2025', '👁️', 'Amsler-Netz Untersuchung', 'Beidseitige Untersuchung mit dem Amsler-Netz.', '', 'Es handelt sich um eine beidseitige Untersuchung, daher fasse ich die zwei Positionen zusammen. Die Datumsangaben sind identisch, daher wird es nur einmal genannt. Die Anzahl wird addiert: 1 + 1 = 2', 32.4),
  (3, '21.01.2025', '👁️', 'Tonometrie Papillenbeurteilung', 'Applanationstonometrie und stereoskopische Papillenbeurteilung, beidseitig', '', 'Die Leistung beinhaltet die Applanationstonometrie und die stereoskopische Papillenbeurteilung beidseitig am 21.01.2025. Daher fasse ich die zusammenfassende Leistung zusammen.', 32.4),
  (3, '21.01.2025', '👁️', 'Fundusaufnahme', 'Beidseitige Fundusaufnahme.', '', 'Die Position beinhaltet die beidseitige Fundusaufnahme am 21.01.2025. Daher fasse ich diese zusammen.', 94.56),
  (3, '21.01.2025', '👁️', 'Spaltlampenuntersuchung', 'Beidseitige Spaltlampenuntersuchung der vorderen Augenabschnitte.', '', 'Die Leistung beinhaltet eine beidseitige Spaltlampenuntersuchung der vorderen Augenabschnitte. Die Tarifziffer 08.1230 deutet auf diese spezifische Untersuchung hin. Das Datum ist der 21.01.2025. Das Emoji Auge wurde gewählt, da es gut zur Untersuchung passt.', 12.15),
  (3, '21.01.2025', '👁️', 'Fundusuntersuchung', 'Eingehende beidseitige Untersuchung des zentralen Fundus und der Fundusperipherie.', '', 'Die Rechnungspositionen beschreiben die Biomikroskopie des zentralen Fundus beidseitig (08.3010) sowie Zuschläge für die Untersuchung der Fundusperipherie auf beiden Seiten (08.3020). Es handelt sich um eine umfassende Untersuchung des gesamten Fundus beider Augen.', 44.55);
